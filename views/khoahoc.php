                ...
                echo '<div class="col-lg-4 col-md-6">
                        <div class="product couress-box mb-40">
                            <div class="product__img">
                                <a href="views/detail.php?course_id=' . $course_id . '"><img src="admin/image/' . $image . '" alt=""></a>
                                <div class="mb"></div>
                            </div>
                            <div class="product__content pt-30">
                                ...
                                <h4 class="pro-title"><a href="views/detail.php?course_id=' . $course_id . '">' . $course_name . '</a></h4>
                                <p>' . $description . '</p>
                                ...
                                <!-- Thêm đoạn mã này để tạo liên kết đến trang chi tiết khóa học -->
                                <a href="views/detail.php?course_id=' . $course_id . '" class="btn ss-btn">View Details</a>
                            </div>
                        </div>
                    </div>';
            }
