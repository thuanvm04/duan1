        ...
        <section class="project-detail">
            <div class="container">
                ...
                <div class="lower-content">
                    <div class="row">
                        <?php
                        include_once('../model/khoahoc.php');
                        ...
                        ?>
                            ...
                            <div class="text-column col-lg-8 col-md-8 col-sm-12">
                                ...
                                <div class="inner-column">
                                    ...
                                    <p><span class="dropcap">U</span> <?php echo $course['intro']; ?></p>
                                ...
                                <aside class="sidebar-widget">
                                    <section class="widget widget_search">
                                        <div class="course-widget-price">
                                            ...
                                            <h6 class="pt-20 pb-20">Course Price: <span><?php echo $course['price']; ?></span></h6>
                                            <a class="btn ss-btn" href="#">ENROLL THIS COURSE</a>
                                        </div>
